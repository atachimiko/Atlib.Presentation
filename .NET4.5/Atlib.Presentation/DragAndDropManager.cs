...
namespace Atlib.Presentation
{
	...
	internal class TreeItemScroll
	{
		...
		private Rect FBottomRect;           // 同、下端部の流域
		private ScrollLine FScrollLine;     // スクロールの要否あるいは方向
		private ScrollViewer FScrollViewer; // TreeView が内蔵する ScrollViewer コントロール
		private System.Windows.Threading.DispatcherTimer FTimer; // スクロールするためのタイマー
